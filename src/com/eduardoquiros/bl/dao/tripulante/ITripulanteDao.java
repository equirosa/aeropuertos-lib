...
public interface ITripulanteDao {
	void insertar(String cedula, String nombre, String apellido1, String apellido2, String email,String contrasenna, String direccion,
	...
	void modificar(String cedula, String nombre, String apellido1, String apellido2, String email,String contrasenna, String direccion,
	               LocalDate fechaNacimiento, Pais nacionalidad,char genero,String numLicencia,String puesto,String telefono,
	               LocalDate fechaGraduacion, String codigoTripulacion) throws Exception;
